...
{
    public class VnPayLibrary : IVnPayService
    {
        ...
        public string CreateRequestUrl(string baseUrl, string vnpHashSecret)
        {
            ...
            foreach (KeyValuePair<string, string> pair in _requestData.Where(kv => !string.IsNullOrEmpty(kv.Value)))
            {
                string key = pair.Key;
        ...
        public string CreatePaymentUrl(Microsoft.AspNetCore.Http.HttpContext context, VnPaymentRequestModel model)
        {
